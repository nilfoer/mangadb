...
# TODO re-add run_ext_companion.py
files_to_include_in_root = ['run_manga_db.py', 'LICENSE.txt', 'README.md', 'requirements.txt',
                            'setup.cfg', 'setup.py']
...
globs = ['manga_db/**/*.py', 'manga_db/webGUI/static/**/*.*',
         'manga_db/webGUI/templates/**/*.*']
